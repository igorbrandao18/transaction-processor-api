...
describe('TransactionsController', () => {
    ...
    beforeEach(async () => {
        ...
        transactionsQueue =
            module.get(transactions_queue_1.TransactionsQueue);
    });
    describe('create', () => {
        it('should queue a transaction and return 202 Accepted', async () => {
            ...
            expect(transactionsQueue.addTransactionJob).toHaveBeenCalledWith(mockCreateDto);
        ...
        it('should handle queue errors', async () => {
            ...
            await expect(controller.create(mockCreateDto)).rejects.toThrow('Queue error');
        });
    });
    describe('findAll', () => {
    ...
    describe('getMetadata', () => {
        it('should return transaction metadata', async () => {
            ...
            transactionsService.getMetadata.mockReturnValue(mockMetadata);
    ...
    describe('getQueueStatus', () => {
        it('should return job status', async () => {
            ...
            expect(transactionsQueue.getJobStatus).toHaveBeenCalledWith(transactionId);
            expect(result).toEqual(mockStatus);
        });
        it('should throw error if job not found', async () => {
            const transactionId = 'non-existent-job';
            transactionsQueue.getJobStatus.mockResolvedValue(null);
            await expect(controller.getQueueStatus(transactionId)).rejects.toThrow(`Job with transactionId "${transactionId}" not found`);
        });
    });
